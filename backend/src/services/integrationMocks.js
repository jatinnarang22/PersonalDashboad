...
export function mockYoutubeSummary() {
  return {
    ...
    note:
      'Demo data. Set GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, GOOGLE_REDIRECT_URI in backend/.env and set USE_INTEGRATION_MOCKS=false for your real YouTube account.',
  };
}
